...
#
# Source0 file verified with key 0xE17DF5C82B4F9D00 (carlton.gibson@noumenal.es)
#
Name     : pypi-asgiref
Version  : 3.6.0
Release  : 48
...
%prep
%setup -q -n asgiref-3.6.0
cd %{_builddir}/asgiref-3.6.0
pushd ..
cp -a asgiref-3.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672255560
