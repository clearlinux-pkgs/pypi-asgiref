...
Source0  : https://files.pythonhosted.org/packages/ea/2b/3face3a7241f61dc1c58dbe243cc02c15c61ccdcafebc4406f7bb40ce731/asgiref-3.5.0.tar.gz
...
%prep
%setup -q -n asgiref-3.5.0
cd %{_builddir}/asgiref-3.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649711668
...
cp %{_builddir}/asgiref-3.5.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-asgiref/baf11129ce63c4eef654f39a360b31cfc7d1ac67
