...
Source0  : https://files.pythonhosted.org/packages/80/c4/83a01607f2d10024c172097126264c8e00c6a4827b35d631ece9625e6ba2/asgiref-3.2.3.tar.gz
...
%prep
%setup -q -n asgiref-3.2.3
cd %{_builddir}/asgiref-3.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583522144
...
cp %{_builddir}/asgiref-3.2.3/LICENSE %{buildroot}/usr/share/package-licenses/asgiref/baf11129ce63c4eef654f39a360b31cfc7d1ac67
