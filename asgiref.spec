...
Source0  : https://files.pythonhosted.org/packages/e9/d1/096b5b0b411a1a53c294a508fdc51542de77bc193df5c8230ff9445e4ff3/asgiref-3.3.1.tar.gz
...
%prep
%setup -q -n asgiref-3.3.1
cd %{_builddir}/asgiref-3.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604970839
...
cp %{_builddir}/asgiref-3.3.1/LICENSE %{buildroot}/usr/share/package-licenses/asgiref/baf11129ce63c4eef654f39a360b31cfc7d1ac67
