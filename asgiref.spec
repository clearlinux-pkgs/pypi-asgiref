...
%prep
%setup -q -n asgiref-3.2.10
cd %{_builddir}/asgiref-3.2.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592582117
...
cp %{_builddir}/asgiref-3.2.10/LICENSE %{buildroot}/usr/share/package-licenses/asgiref/baf11129ce63c4eef654f39a360b31cfc7d1ac67
