...
Source0  : https://files.pythonhosted.org/packages/3e/34/fb6c2b2b858d27cdc6703e26e304d56e2300c33719b9407eae54a6b80423/asgiref-3.3.0.tar.gz
...
%prep
%setup -q -n asgiref-3.3.0
cd %{_builddir}/asgiref-3.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602518231
...
cp %{_builddir}/asgiref-3.3.0/LICENSE %{buildroot}/usr/share/package-licenses/asgiref/baf11129ce63c4eef654f39a360b31cfc7d1ac67
