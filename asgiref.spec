...
Version  : 3.4.0
Release  : 20
URL      : https://files.pythonhosted.org/packages/c0/9d/b1c128ed26b8c01c27e5c393c558e9c2a6716dfbdb59f97ba14960fbde76/asgiref-3.4.0.tar.gz
...
%prep
%setup -q -n asgiref-3.4.0
cd %{_builddir}/asgiref-3.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624891418
...
cp %{_builddir}/asgiref-3.4.0/LICENSE %{buildroot}/usr/share/package-licenses/asgiref/baf11129ce63c4eef654f39a360b31cfc7d1ac67
