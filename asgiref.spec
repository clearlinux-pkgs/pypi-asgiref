...
Version  : 3.3.2
Release  : 15
URL      : https://files.pythonhosted.org/packages/5f/56/af1c760bd245eb1625ef1fb60c25a6d03084e263c2882da74aad38ddf075/asgiref-3.3.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/5f/56/af1c760bd245eb1625ef1fb60c25a6d03084e263c2882da74aad38ddf075/asgiref-3.3.2.tar.gz
...
%prep
%setup -q -n asgiref-3.3.2
cd %{_builddir}/asgiref-3.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617718618
...
cp %{_builddir}/asgiref-3.3.2/LICENSE %{buildroot}/usr/share/package-licenses/asgiref/baf11129ce63c4eef654f39a360b31cfc7d1ac67
