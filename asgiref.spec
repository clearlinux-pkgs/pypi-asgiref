...
Source0  : https://files.pythonhosted.org/packages/d8/3f/ef696a6d8254f182b1a089aeffb638d2eb83055e603146d3a40605c5b7da/asgiref-3.3.4.tar.gz
...
%prep
%setup -q -n asgiref-3.3.4
cd %{_builddir}/asgiref-3.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617808001
...
cp %{_builddir}/asgiref-3.3.4/LICENSE %{buildroot}/usr/share/package-licenses/asgiref/baf11129ce63c4eef654f39a360b31cfc7d1ac67
